...
export default (props) => {
    const [values, setValues] = useState({title:props.posts[0].title,content:props.posts[0].content})
    ...
    function handleSubmit(e){
       ...
       const data = {id:props.posts[0].id,title:values.title,content:values.content}
    ...
    return (
        <div className="flex flex-col place-items-center bg-yellow-100 h-screen p-5">
            <h1 className="text-[40px] bg-[#ffcc5c] rounded-sm w-full text-center mb-5">Editar nota</h1>
            <form method="post" id="create-note" onSubmit={handleSubmit} className="flex flex-col min-w-[240px] max-w-[360px] bg-[#88d8b0] border-2 border-[#88d8b0] overflow-hidden  ">
